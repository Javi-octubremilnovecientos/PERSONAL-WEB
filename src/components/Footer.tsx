...
export default function Footer() {
  ...
  const Links = [
    {
      label: "GITHUB",
      link: "https://github.com/orgs/Porfolio-Javier-Lombardero/repositories"
    },
    {
      label: "LINKEDIN",
      link: "https://www.linkedin.com/in/javier-lombardero-front-end/"
    }
  ]

  return (
    <footer className="flex flex-col md:flex-row justify-between items-center px-6 md:px-12 py-8 gap-4 bg-surface-bright dark:bg-terminal-black border-t-2 border-terminal-black dark:border-surface-bright w-full">
