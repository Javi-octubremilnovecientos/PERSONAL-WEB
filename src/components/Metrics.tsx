...
export default function Metrics() {
  ...
  return (
    <section className="space-y-6">
      <SectionHeader id="002" title="CORE_METRICS" />
      
      <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-terminal-black dark:bg-surface-bright brutalist-border">
        {metrics.map((metric, i) => (
          <div key={i} className="bg-surface-bright dark:bg-terminal-black p-4 flex flex-col gap-2 relative group hover:bg-terminal-black/5 dark:hover:bg-surface-bright/10 transition-colors">
